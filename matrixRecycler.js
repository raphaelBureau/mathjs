...
export class MatrixRecycler {
    ...
    Vec3Prod(mat, vecmat) { //vecmat is a matrix of 3 vectors
        this.intermediateValues[0] = mat[0] * vecmat[0] + mat[1] * vecmat[3] + mat[2] * vecmat[6] + mat[3] * vecmat[9];
        this.intermediateValues[1] = mat[4] * vecmat[0] + mat[5] * vecmat[3] + mat[6] * vecmat[6] + mat[7] * vecmat[9];
        this.intermediateValues[2] = mat[8] * vecmat[0] + mat[9] * vecmat[3] + mat[10] * vecmat[6] + mat[11] * vecmat[9];
        this.intermediateValues[3] = mat[12] * vecmat[0] + mat[13] * vecmat[3] + mat[14] * vecmat[6] + mat[15] * vecmat[9];

        this.intermediateValues[4] = mat[0] * vecmat[1] + mat[1] * vecmat[4] + mat[2] * vecmat[7] + mat[3] * vecmat[10];
        this.intermediateValues[5] = mat[4] * vecmat[1] + mat[5] * vecmat[4] + mat[6] * vecmat[7] + mat[7] * vecmat[10];
        this.intermediateValues[6] = mat[8] * vecmat[1] + mat[9] * vecmat[4] + mat[10] * vecmat[7] + mat[11] * vecmat[10];
        this.intermediateValues[7] = mat[12] * vecmat[1] + mat[13] * vecmat[4] + mat[14] * vecmat[7] + mat[15] * vecmat[10];

        this.intermediateValues[8] = mat[0] * vecmat[2] + mat[1] * vecmat[5] + mat[2] * vecmat[8] + mat[3] * vecmat[11];
        this.intermediateValues[9] = mat[4] * vecmat[2] + mat[5] * vecmat[5] + mat[6] * vecmat[8] + mat[7] * vecmat[11];
        this.intermediateValues[10] = mat[8] * vecmat[2] + mat[9] * vecmat[5] + mat[10] * vecmat[8] + mat[11] * vecmat[11];
